    ...
    @try{
        ...
        if (! lounges){
            lounges =[ [NSArray alloc] initWithObjects:@"Air Tran Club Lounge",
                      @"American Airlines Club", @"Continental Airlines Club Lounge", @"Delta Airline Crown Room", @"Hawaiian Airline Club Room", @"KLM - Royal Dutch Airlines Club Lounge",@"Swiss International Lounge",  @"United Airlines Club Lounge",@"Varig Club Lounge",nil];
        }
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.accessoryView.tintColor = [UIColor whiteColor];
        ...
        UIImage *cellImage = [Utilities getParseImage:appDelegate.loungesbackgrounds anyIndex:indexPath.row];
